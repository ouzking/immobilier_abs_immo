      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md">
          <button onClick={() => navigate('home')} className="flex items-center gap-3 mb-10 group">
            ...
            <span className="font-bold text-[#0F4C81] text-lg">ABS IMMO & SERVICES</span>
          </button>

          <h1 className="text-3xl font-bold text-gray-900 mb-2">Connexion</h1>
          <p className="text-gray-500 mb-8">Accédez à votre espace personnel sécurisé</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button type="button" className="text-[#0F4C81] text-xs font-medium hover:underline">Mot de passe oublié ?</button>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <button onClick={() => navigate('register')} className="text-[#0F4C81] font-semibold hover:underline">
              Créer un compte
            </button>
          </p>
        </div>
      ...
      <div className="hidden lg:block w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-10 right-10">
          ...
          <div className="flex items-center gap-3">
            <img src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=60" alt="Elhadji Sané" className="w-10 h-10 rounded-full object-cover border-2 border-white/50" />
            <div>
              <div className="text-white font-semibold text-sm">Elhadji Sané</div>
              <div className="text-blue-200 text-xs">Fondateur, ABS Immo & Services</div>
            </div>
          </div>
        </div>
      </div>
